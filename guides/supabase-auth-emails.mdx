...
<Note>
  ...
  [hi@senderkit.com](mailto:hi@senderkit.com) for manual endpoint provisioning.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Custom sending domains" icon="envelope-circle-check" href="/concepts/channels-and-providers#custom-sending-domains-pro">
