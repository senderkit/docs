...
The SenderKit MCP server exposes seven tools, identical across the hosted
...
test mode is determined by the API key prefix (`sk_live_` / `sk_test_`).
...
live vs test mode is determined by the API key prefix.
...
<ParamField path="channel" type='"email" | "sms" | "push"' required>
...
<ParamField path="body" type="string">
  Message body. Required for `channel: "sms"` and `channel: "push"`.
</ParamField>
<ParamField path="title" type="string">
  Push notification title. Required for `channel: "push"`.
</ParamField>
...
<ParamField path="pushData" type="object">
  Push data payload as a JSON object of string values.
</ParamField>
<ParamField path="vars" type="object">
