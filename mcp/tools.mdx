...
The SenderKit MCP server exposes fifteen tools, identical across the hosted
...
Create a new inbound email address that receives mail for the workspace and,
optionally, forwards it and/or fires a webhook on receipt. Mirrors
