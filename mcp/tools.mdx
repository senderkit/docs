...
<ParamField path="from" type="string">
  Email from-address override. Must match a [verified custom sending domain](/concepts/channels-and-providers#custom-sending-domains-pro) when using the managed email sender.
</ParamField>
...
<ParamField path="slug" type="string">
  URL-safe identifier (`letters`, digits, `_` or `-`). Auto-derived from the
  brief if omitted; a numeric suffix is appended on collision.
</ParamField>
