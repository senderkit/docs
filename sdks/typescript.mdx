...
<ParamField path="baseUrl" type="string" default="https://senderkit.com/api">
...
<ParamField path="channel" type='"email" | "sms" | "push"'>
...
<ParamField path="params.channel" type='"email" | "sms" | "push"'>
  Filter by channel.
</ParamField>
